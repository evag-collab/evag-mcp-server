/**
 * Function to fetch country details from the MCP server.
 *
...
/**
 * Tool configuration for fetching country details from the MCP server.
 * @type {Object}
 */
const apiTool = {
  ...
  definition: {
    ...
    function: {
      name: 'get_countries',
      description: 'Fetch country details from the MCP server.',
      parameters: {
        type: 'object',
        properties: {
          countryISO3: {
